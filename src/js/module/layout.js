...
define(function(require, exports, module) {
  "use strict";
  var Layout, postParent;
  postParent = function(mes, origin) {
    return parent.postMessage(JSON.stringify(mes), "*");
  };
  Layout = (function() {
    ...
    Layout.prototype.enter_fullscreen = function() {
      console.log(this.element.origin);
      postParent("enter_fullscreen", this.element.origin);
    };

    Layout.prototype.exit_fullscreen = function() {
      postParent("exit_fullscreen", this.element.origin);
    };
